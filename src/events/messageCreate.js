...
async function messageHandler(message) {
	...
	if (message.channelId === 'Insert Bot Spam Channel ID here!' || message.channelId === '415616380570697729') { // Holds both your testing channel id and the Pretendo Botspam channel id
		switch (jokeRegex) {
			case 'redux':
